...
<!--                        </a>-->
<!--                        <p class="px-1">/</p>-->
<!--                        <p class='view-breadcrumb'>--><?php //=$project->title;?><!--</p>-->
<!--                    </div>-->
...
<!--                        <div class="project-title">--><?php //=$project->title;?><!--</div>-->
<!--                        <div class="project-description">--><?php //=$project->description;?><!--</div>-->
<!--                        <!--<a href="#" class="project-button"><span>Посмотреть сайт</span><span class="think-arrow-right"></span></a>-->
<!--                        <a class="iconbutton iconbutton--border" href="--><?php //=$project->url;?><!--">-->
...
<!--                    <img src="images/--><?php //=$project->img_banner;?><!--" alt="image">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
    ...
    <main>
        <div class="sections">
                                                    ...
                                                    <?php if (!empty($projects)): ?>
                                                        <div class="row">
                                                            <?php foreach ($projects as $project_item): ?>
                                                                <div class="col-md-6 filtr-item" data-category="<?=$project_item->cat_id;?>">
                                                                    <div class="grid">
                                                                        <figure class="effect-apollo">
                                                                            <img src="images/<?=$project_item->img_preview;?>" alt="image"/>
                                                                            <figcaption>
                                                                                <h2><span><?=h($project_item->title);?></span></h2>
                                                                                <a href="<?=PATH?>/project/view?id=<?=$project_item->id;?>">Посмотреть проэкт</a>
                                                                            </figcaption>
                                                                        </figure>
                                                                    </div>
                                                                </div>
            ...
            <!-- index -->
            <div class="sections__index block-none hidden">
            ...
            <!-- navigation down -->
            <nav class="sections__nav block-none hidden">
            ...
            <!-- sections -->
            <section class="section section-1 section--current section-1-view">
                <div class="section__content">
                    <h1 class="project-name"><?= h($project->title);?></h1>
                    <p class="section__description">
                        <span class="section__description-inner project-desc"><?= h($project->description);?></span>
                    </p>
                </div>
    ...
    <?php if (!empty($project->video_small)): ?>
