                                        ...
                                        <div class="box box-info box-solid file-upload">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <p>
                                                    <small>
                                                        Recommended size:
                                                        <?=\furniture\App::$app->getProperty('article_width'); ?>
                                                        x
                                                        <?=\furniture\App::$app->getProperty('article_height'); ?>
                                                    </small>
                                                </p>
                                                <div class="article">
                                                    <img src="/images/<?=$article['img'];?>" alt="image" class="img-course del-img-article"
